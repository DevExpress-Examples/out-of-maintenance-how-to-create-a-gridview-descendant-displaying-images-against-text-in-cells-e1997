...
Namespace ImageTextEdit
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.imageCollection1.Images.SetKeyName(0, "user_male24.bmp")
			Me.imageCollection1.Images.SetKeyName(1, "user_male24_d.bmp")
			Me.imageCollection1.Images.SetKeyName(2, "home_purple24.bmp")
			Me.imageCollection1.Images.SetKeyName(3, "home_purple24_d.bmp")
			Me.imageCollection1.Images.SetKeyName(4, "web_search24_h.bmp")
			Me.imageCollection1.Images.SetKeyName(5, "web_search24_d.bmp")
			' 
			' customGridControl1
			' 
			...
			Me.customGridControl1.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() { Me.customAdvGridView1, Me.customGridView2, Me.customGridView1})
			' 
