...
{
    public class CustomAdvGridView : AdvBandedGridView
    {
        GridCellInfo nowDrawingCellInfo;
        public CustomAdvGridView() : base() { }
        public CustomAdvGridView(GridControl grid) : base(grid) { }
        ...
        public override void Assign(BaseView v, bool copyEvents)
        {
            ...
            try
            {
                CustomAdvGridView gv = v as CustomAdvGridView;
                if (gv != null)
                    if (copyEvents)
        ...
        protected override string ViewName { get { return "CustomAdvGridView"; } }
